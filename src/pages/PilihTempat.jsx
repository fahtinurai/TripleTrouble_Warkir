    ...
    return (
      <div className="bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100">
        <div className="container mx-auto px-6 min-h-[calc(100vh-8rem)] md:min-h-[calc(100vh-10rem)] flex flex-col items-center justify-center text-center py-12">
          <h1 className="text-5xl font-extrabold mb-4 text-gray-800">Pilih Tempat</h1>
          <p className="text-gray-600 mb-10 text-lg">Silakan pilih tempat sebelum memesan</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full max-w-2xl">
            ...
            >
              🍽️ Dine In
              <span className="text-sm font-normal mt-1 text-gray-500">Makan di tempat</span>
            </Link>
            ...
            >
              🛍️ Take Away
              <span className="text-sm font-normal mt-1 text-gray-500">Bawa pulang</span>
            </Link>
          </div>
        </div>
      </div>
